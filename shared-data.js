const IoTShared = (() => {
  ...
  const homeSeed = [
    { id:'U-001', domain:'home', name:'客厅空调', room:'客厅', type:'aircon', icon:'❄', desc:'中央空调 · 最近连接正常', online:true, temp:24, mode:'制冷', fan:'自动', on:true, alert:false },
    { id:'U-002', domain:'home', name:'客厅主灯', room:'客厅', type:'light', icon:'☼', desc:'智能吸顶灯 · 亮度 80%', online:true, brightness:80, on:true, alert:false },
    { id:'U-003', domain:'home', name:'主卧空气净化器', room:'卧室', type:'air', icon:'◌', desc:'自动模式 · 空气优', online:true, aqi:28, on:true, alert:false },
    { id:'U-004', domain:'home', name:'主卧门锁', room:'卧室', type:'lock', icon:'⌑', desc:'指纹锁 · 3 小时前已锁', online:true, locked:true, alert:false },
    { id:'U-005', domain:'home', name:'厨房烟雾传感器', room:'厨房', type:'sensor', icon:'◈', desc:'环境监测 · 需要关注', online:true, alert:true, temp:31.8, humidity:null },
    { id:'U-006', domain:'home', name:'厨房顶灯', room:'厨房', type:'light', icon:'☼', desc:'智能射灯 · 关闭', online:true, brightness:0, on:false, alert:false },
    { id:'U-007', domain:'home', name:'阳台水泵', room:'阳台', type:'pump', icon:'≈', desc:'灌溉设备 · 定时运行', online:true, on:false, alert:false },
